...
def main(args):
    ...
    memory = ReplayMemory(capacity, args.output_dir)
    ...
    if args.resume:
        ...
        episode = memory.load('rl_experience')
        logging.info('Load reinforcement learning trained weights. Resume training')
    elif os.path.exists(il_weight_file):
        # model.load_state_dict(torch.load(il_weight_file))
        policy.load_state_dict(torch.load(il_weight_file))
        _ = memory.load('il_experience')
        logging.info('Load imitation learning trained weights.')
    else:
        il_episode_done = memory.load('il_experience')
        il_episodes = train_config.imitation_learning.il_episodes - il_episode_done
        ...
        explorer.run_k_episodes(
            ...
            imitation_learning=True, memory_name='il_experience')
    ...
    while episode < train_episodes:
        ...
        explorer.run_k_episodes(
            sample_episodes, 'train', update_memory=True,
            episode=episode, memory_interval=checkpoint_interval)
